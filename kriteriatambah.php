  ...
  <body>
                ...
                <div class="panel-body">
                    ...
                    <div class="tab-content">
                      ...
                      <form class="form" action="kriteriatambah.php" method="post">
                        ...
                        <div class="form-group">
                          <input class="form-control" type="text" name="tp_krit" placeholder="Tipe Kriteria">
                        </div>
                        <div class="form-group">
    ...
    if (isset($_POST['simpan'])) {
      ...
      if ($row = $tambah->fetch_row()) {
        ...
        $masuk = "INSERT INTO tab_kriteria VALUES ('".$id_krit."','".$kriteria."','".$tp_krit."','".$bobot."')";
